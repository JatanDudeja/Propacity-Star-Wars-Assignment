...
export default function DetailSideBarPage() {
    ...
    const { detail, closeDetailSideBar, starShipsData } = useGlobalContext()
    
    const { id } = detail
    // console.log("in side bar : " + pageData)
    // console.log("page data", pageData)

    const obj = starShipsData.find((item) => {
        console.log(item)
        return (
            item.name === id
        )
    ...
    return (
        <div className="detail-sidebar">
            ...
            <div className='detailSidebar-data'>
                ...
                <div className='detailSidebar-data-content'>
                    <p className='heading'>Hyperdrive Rating</p>
                    <p className='summary'>{obj.hyperdrive_rating}</p>
                </div>
                <div className='detailSidebar-data-content'>
                    <p className='heading'>MGLT</p>
                    <p className='summary'>{obj.MGLT}</p>
                </div>
                <div className='detailSidebar-data-content'>
                    <p className='heading'>Starship Class</p>
                    <p className='summary'>{obj.starship_class}</p>
                </div>
            </div>
